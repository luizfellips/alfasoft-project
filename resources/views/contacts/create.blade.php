        ...
        <div class="p-10 rounded shadow-sm border-2 border-opacity-35 border-blue-700 max-w-lg w-2/3">
            ...
            <form action="{{ route('contacts.store') }}" method="POST">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <input type="text" placeholder="Contact number" name="contact[contact]" maxlength="9"
                        class="mt-2 px-4 py-2 shadow rounded" />
                </div>
                <div class="mt-6 flex gap-6">
                    <button type="submit"
                        class="rounded-full bg-blue-500 py-4 px-10 fs-3 font-bold container transition text-white shadow hover:bg-blue-600">Register</button>
                </div>
            </form>
        </div>
    </div>
